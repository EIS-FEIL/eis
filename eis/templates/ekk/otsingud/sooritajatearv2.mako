...
<div class="gray-legend p-3 filter-w">
  ...
  <div class="col d-flex justify-content-end align-items-end">
    <div class="form-group">
      ${h.btn_search()}
      ${h.submit(_("Kõige viimased andmed"), id="viimane")}
...
<div class="listdiv">
<%include file="sooritajatearv2_list.mako" />
</div>
