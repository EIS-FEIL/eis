...
<h1>${_("Testitulemuste võrdlus")}</h1>
  ...
  <div class="row filter">
    ...
    <div class="col-12 col-md-4 col-lg-3">
      <div class="form-group">    
        ${h.flb(_("Testimiskord"),'testimiskord_id')}
            ...
            %>
            ${h.select('testimiskord_id', c.testimiskord_id, opt_testimiskord, empty=True)}
      <script>
    ...
    <div class="col-12 col-md-4 col-lg-3">
      <div class="form-group">    
        ...
        ${h.posfloat('erinevus', c.erinevus or 15, size=6)} ${_("palli")}
      </div>
    </div>
    <div class="col-12 col-md-8 col-lg-9">
      <div class="form-group">    
            <% if not c.vrld: c.vrld = 'tkord' %>
            ${h.radio('vrld', 'tkord', checkedif=c.vrld, 
            label=_("Võrdle sooritaja tulemusi sama testi eri testimiskordadel"))}
            ${h.radio('vrld', 'aine', checkedif=c.vrld, 
            label=_("Võrdle sooritaja tulemusi sama õppeaine ja testiliigiga testides"))}
            ${h.radio('vrld', 'tase', checkedif=c.vrld, 
            label=_("Võrdle sooritaja tulemusi sama õppeaine ja tasemega testides"))}            
      </div>
    </div>
  </div>
...
<div class="listdiv">
  ...
  % elif c.items:
  <%include file="testitulemused_list.mako"/>
  % endif 
</div>
