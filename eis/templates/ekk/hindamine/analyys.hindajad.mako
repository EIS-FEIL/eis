...
<%def name="page_title()">
${c.toimumisaeg.testimiskord.test.nimi} ${c.toimumisaeg.millal} | ${_("Läbiviijate töö analüüs")}
</%def>      
...
${h.crumb(_("Läbiviijate töö analüüs"))}
</%def>
...
<h3>${_("Läbiviijate töö analüüs")}</h3>

${h.form_search(url=h.url('hindamine_analyys_hindajad', toimumisaeg_id=c.toimumisaeg.id))}
...
<div class="listdiv">
<%include file="analyys.hindajad_list.mako"/>
</div>
<br/>
