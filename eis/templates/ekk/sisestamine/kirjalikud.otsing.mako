...
<h1>${_("Kirjaliku vastamisega p-testi hindamisprotokolli sisestamine")}</h1>
${h.form_search(url=h.url('sisestamine_kirjalikud'))}
...
<div class="listdiv">
<%include file="kirjalikud.otsing_list.mako"/>
</div>
