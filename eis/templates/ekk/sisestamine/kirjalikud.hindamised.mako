...
<%def name="page_title()">
${_("Kirjaliku vastamise hindamisprotokolli sisestamine")}
</%def>      
<%def name="breadcrumbs()">
${h.crumb(_('Kirjaliku vastamise hindamisprotokolli sisestamine'),
...
${h.form_search(h.url('sisestamine_kirjalikud'))}
${h.hidden('sisesta','1')}
${h.hidden('ta_tahised',c.toimumisaeg.tahised)}
${h.hidden('sessioon_id',c.toimumisaeg.testimiskord.testsessioon_id)}
${h.hidden('toimumisaeg_id',c.toimumisaeg.id)}
...
${_("Hindamise liik: ")}
${h.select('liik', c.hindamisprotokoll.liik, c.opt_liik, wide=False, tabindex=100)}
% endif
