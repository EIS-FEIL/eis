## Suulise testi hindamisprotokollide sisestamine, 
## hindamisprotokollide loetelu otsinguvormil

% if c.items != '':
${h.pager(c.items, msg_not_found=_('Protokolle ei leitud'), msg_found_one=_('Leiti 1 protokoll'), msg_found_many=_('Leiti {n} protokolli'))}
% endif
...
<table width="100%" class="table table-borderless table-striped" border="0" >
  ...
  <tbody>
    ...
    <tr>
      <td>${ta_tahised} <!--hpr${hpr.id}--></td>
      ##<td>${tkoht_tahised}<!-- hpr ${hpr.id}--></td>
      % if tk.sisestus_isikukoodiga:
      <td>
        % if r_tahis:
        ${k_nimi}, ruum ${r_tahis}
      ...
      <td>
        ...
        ${h.link_to(hpr.staatus1_nimi, h.url('sisestamine_suulised_hindamised',
      ...
      <td>
        ...
        ${h.link_to(hpr.staatus2_nimi, h.url('sisestamine_suulised_hindamised',
      ...
      <td>
        ...
        ${h.link_to(hpr.staatus_nimi,h.url('sisestamine_suulised_hindamised',
