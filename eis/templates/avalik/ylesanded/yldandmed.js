...
$(function(){
    ...
    $('#addsubject').click(function(){
        ...
        var div_new = $('<div class="form container ylesandeaine"></div>').appendTo(div_ained);
    ...
    $('#f_arvutihinnatav').change(function(){
        if($(this).val() == '1')
        {
            ...
            if(v != '${const.VASTVORM_KE}' && v != '${const.VASTVORM_SE}' && v != '${const.VASTVORM_KP}' && v != '${const.VASTVORM_I}')
