"""
Riigiportaali autenditud kasutaja suunamine EISi tasemeeksamite registreerimise vormile. Teenusega genereeritakse EISis unikaalne ühekordselt kasutatav URL, mis seotakse teenuse kasutaja identiteediga. Riigiportaal suunab kasutaja sellele URLile, EIS loeb kasutaja autendituks ilma täiendava sisse logimiseta ning avab soovitud liiki eksamitele registreerimise vormi.
"""
...
def serve(paring, header=None, attachments=[], context=None):
    ...
    return add_legacy(paring, header, context, const.TESTILIIK_TASE)
