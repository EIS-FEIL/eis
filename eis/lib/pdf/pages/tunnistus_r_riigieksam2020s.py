# -*- coding: utf-8 -*- 
"Riigieksamitunnistus 2020 sügis"
# 2020 sügise lisaeksamid
...
Võõrkeeles võis õpilane sooritada inglise keele riigieksami või rahvusvaheliselt tunnustatud võõrkeeleeksami inglise, prantsuse, saksa või vene keeles. 
...
At the time of issuing the present certificate, the mandatory examinations for graduating from upper secondary school are Estonian/Estonian as a second language, mathematics and foreign language.  
