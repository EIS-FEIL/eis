...
Võõrkeeles võis õpilane sooritada inglise keele riigieksami, vene keele võõrkeelena B1-tasemel riigieksami või rahvusvaheliselt tunnustatud võõrkeeleeksami inglise, prantsuse või saksa keeles. 
...
At the time of issuing the present certificate, the mandatory examinations for graduating from upper secondary school are Estonian/Estonian as a second language, mathematics, English, Russian as a foreign language on the level B1 and internationally recognised foreign language examinations.   
