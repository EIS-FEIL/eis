...
def generate(story, tunnistusenr, valjastamisaeg, nimi, kasutaja, sessioon, q_sooritajad, sooritaja1):
    ...
    buf_et = """Käesoleva tunnistuse väljaandmise ajal ei olnud  riigieksamite sooritamine gümnaasiumis lõpetamise tingimuseks. Õpilastel oli võimalik sooritada  eesti keele / eesti keele kui teise keele, matemaatika, inglise keele ja rahvusvaheliselt tunnustatud võõrkeele eksami.
...
At the time of issuing the present certificate, it was not mandatory to take state examinations in order to graduate from upper secondary school. Students had the option of taking Estonian/Estonian as a second language, mathematics, English and internationally recognised foreign language examinations.
...
<u><b>English</b></u>: <i>Certificate in Advanced English (CAE)</i>; <u><b>French</b></u>: <i>Diplôme d'études en langue française B1, Diplôme d'études en langue française B2</i>; <u><b>German</b></u>: <i>Goethe-Zertifikat B1, Goethe- Zertifikat B2, Deutsches Sprachdiplom II B2,Deutsches Sprachdiplom II C1, Deutschprufung der Allgemeinen deutschen Hochschulreife</i>; <u><b>Russian</b></u>: <i>Тест по русскому языку как иностранному B1, Тест по русскому языку как иностранному B2</i>.  
